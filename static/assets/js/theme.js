...
function layout_change(layout) {
  ...
  const logoPaths = isDark ? '/static/assets/images/logo-white.svg' : '/static/assets/images/logo-dark.svg';

  const landingLogoPath = isDark ? '/static/assets/images/logo-white.svg' : '/static/assets/images/logo-dark.svg';
